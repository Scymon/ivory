...
function prepareBase(){deactivateCanvas();deactivateImage();editorHost.classList.add('hidden');readingHost.classList.add('hidden');welcome.classList.add('hidden');}
...
window.addEventListener('ivory:show-markdown',prepareMarkdown);window.addEventListener('ivory:show-canvas',prepareCanvas);window.addEventListener('ivory:show-image',prepareImage);
